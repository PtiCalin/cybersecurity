# Foundations — Cybersecurity Fundamentals

This directory contains foundational cybersecurity concepts that underpin all other security domains.
...
4. Risk Analysis — Systematic risk assessment
5. Security Governance — Organizational security
6. Defense in Depth — Practical security architecture

**Prerequisites:** Basic computer literacy

**Leads to:** All other security domains build on these foundations

---

## Integration

**Examples:** See `02_examples/00-foundations/` for practical demonstrations
**Exercises:** Practice in `03_exercises/00-foundations/`
**References:** Course materials in `05_references/course-materials/IFT2830_course-materials/`

---

**Key:** 🟢 Beginner | 🟡 Intermediate | **Bold** = Priority/Complete
